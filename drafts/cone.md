...
**Observation.** Consider a two-dimensional electron gas confined to a honeycomb lattice. Near the K-points of the Brillouin zone, the dispersion relation takes the linear form yielding a pair of Dirac cones touching at a single nodal point.
...
*Comment.*
<span style="padding-left: 40px; display:block">
This one plants a flag on a dungheap and cannot help but praise it; in pointing the way, he loses the way and ends up holding a pile of dung. One should praise nothing and point nowhere; in so saying, I plant my flag on the same heap.
</span>
