...
We set up a workshop next to the hab to smelt, fuse, solder, program. It is fun in a routine way, the AI politely instructing, checking with the quant farm every couple of hours, breaking things and melting them back together. Eventually we have a long-baseline, reconfigurable polarimeter up and running, and the signal has repeated almost 20 times; each repeat 11422 structural units long, so twice 5711, and starting with two fine-grained units that vary much more rapidly. Probably initials. We flip a coin to designate the sideband role; we have enough trits to calibrate the polarimeter up to negligible error. And here is where things get strange: once calibration is complete, half the signal drops out. The AI: "This is disturbingly acausal."
