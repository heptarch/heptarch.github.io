...
The stellae are inscribed with what appears, statistically, to be ternary noise, "free entropy" as one of our quants calls it. Why three symbols? Perhaps they couldn't count lower, one xenologist jokes. Another suggests that ternary has the most efficient radix economy of any natural number. Our chief quant is convinced that two symbols represent basis states, and the last a change of basis, with the whole encoding a BB84-style quantum-computational protocol. Professionally speaking, I have no opinion: I'm paid to look at shit, collect samples, scrape the moss off bus stops so to speak. Thirteen symbols it would be the same to me.
