...
*Loft.* A retractible ladder ascends to a loft bedroom, with total footage $\approx 7 \text{ m}^2$, able to comfortably accomodate a queen bed ($1.53 \times 2.03 \text{ m}^2$) provided 
