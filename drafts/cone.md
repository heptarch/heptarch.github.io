...
Borges, in his inimitable history *The Fearful Sphere of Pascal*, gives us the following Hermetic recipe: "God is an intelligible sphere, whose center is everywhere and whose circumference is nowhere." Treating this only as a problem of metaphysical imagination and not theology, we see immediately that such a sphere, as stated, is hardly intelligible. A sphere is defined by its centre and extent, hence circumference; without locating them precisely, we cannot have a sphere at all, a fact both Albertelli and Aristotle point out. Parmenides offers an escape route: the image of an *infinitely expanding* sphere. This anticipates in some respects cosmological models of the Big Bang, but there the picture is inverted, with matter confined to an expanding sphere whose circumference is everywhere and whose centre is nowhere.

We must search in a different direction for the Parmenidean sphere. In contrast to the static tableau of Hermes Trismegitus, Parmenides suggests a *dynamic* conception of deity, God as process, as continual unfolding, which in its concession to the human experience of time and finitude, has less of that uncanny geometry that would lead Pascal to declare the sphere "fearful". 

So something friendlier to human cognition and the experience of time. But what does it entail? At some point, infinitely long ago, the seed of this dynamic God came into being and began expanding.
