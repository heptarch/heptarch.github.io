...
Borges, in his inimitable history *The Fearful Sphere of Pascal*, gives us the following Hermetic recipe: "God is an intelligible sphere, whose center is everywhere and whose circumference is nowhere." We treat this as a problem of metaphysical imagination rather than theology. The problem with the formula, as stated, is that the sphere is hardly intelligible. It must have circumference and centre to be a sphere! These are definitional; without precisely locating them, we cannot have a sphere at all, as both Albertelli and Aristotle point out. Parmenides offers an escape route: the image of an *infinitely expanding* sphere. This is not so different from certain cosmological models of the Big Bang, but unfortunately they invert the description, with matter confined to an expanding sphere whose circumference is everywhere and whose centre is nowhere.
