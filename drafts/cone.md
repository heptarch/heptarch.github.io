...
The Pyramid: a slate-blue frustrum, towering decametres grimly over the Leix Chaos, the smear of Agenor Linea visible to the south and a jungle of stelae crowding the entrance. Clipper II picked it up on the last flyby, so we manned Clipper III and set up habs nearby; gravimetry confirms it extends miles below, and laser spectroscopy that it's made of molybdenum, a metal only fused in supernovae. Xenos on the wire are split between tomb, nuclear dump and data repository... Your classic black monolith scenario. But the geigers are quiet so far.
...
But the puzzle takes on its own life. Each stele starts like a Gothic manuscript, with what appears to be an ornamented initial, distinct and far more elaborate than the trits. Coordinates, ideographs, mathematical formulae, each quant and xeno has their own hypothesi. If you stare at them enough—and I've spent hours—and certain motifs begin to emerge.
