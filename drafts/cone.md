...
VII. <a href="#sec-7"><i>Draft</i></a><br>
...
*Form.* The exterior wall is cut out of sheet metal: a circle of radius $4$ metres, with a sector subtending an angle or *conical deficit* $\alpha = 72^\circ$ excised. Folding the edges of the sector together creates a cone of radius and height
$$
r = \left(1 - \frac{\alpha}{360^\circ}\right) 5 \text{ m} = 4\text{ m}, \quad h = \sqrt{5^2 - 4^2}\text{ m} = 3 \text{ m}.
$$
