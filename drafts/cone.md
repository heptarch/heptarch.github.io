...
*Doorway.* The doorway is a recessed conic section, obtained from intersecting a vertical plane with the cone, i.e. a hyperbola. The offset ($\Delta r = 1.5 \text{ m}$) is such that the height of the door is $2 \text{ m}$. The two halves of the door can be excised from the edges of the sector via the [inverse sine curve](https://www.diva-portal.org/smash/get/diva2:1633435/FULLTEXT02.pdf)
