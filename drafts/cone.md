...
Borges, in his inimitable history *The Fearful Sphere of Pascal*, gives us the following Hermetic recipe: "God is an intelligible sphere, whose center is everywhere and whose circumference is nowhere." Treating this only as a problem of metaphysical imagination and not theology, we see immediately that such a sphere, as stated, is hardly intelligible. A sphere is defined by its centre and radius, hence the circumference which consists of fixed separation from the centre; without locating either precisely, we cannot have a sphere at all, a fact both Albertelli and Aristotle point out. Parmenides offers an escape route: the image of an *infinitely expanding* sphere. This anticipates in some respects cosmological models of the Big Bang, but there the picture is inverted, with matter confined to an expanding sphere whose circumference is everywhere and whose centre is nowhere.

We must search in a different direction for the Parmenidean sphere. In contrast to the static tableau of Hermes Trismegitus, Parmenides suggests a *dynamic* conception of deity, God as process, as continual unfolding. In its concession to the human experience of time and finitude, it has less of the uncanny geometry that would lead Pascal to declare the sphere "fearful". But process is not without its antinomies. We are tempted to picture the unfolding as incomplete, ongoing, momentarily paused. This does violence to the conception of Deity; hence Parmenides' formulation of "infinitely expanding", which conveys not a centreless sphere,
