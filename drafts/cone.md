...
But the puzzle takes on its own life. Each stele starts like a manuscript, with a large, ornamental-looking configuration we call an initial. Stare at them long enough and motifs begin to emerge; I doodle them in my log-book sometimes, killing time between signals from earth. They look a bit like Chinese characters mixed with circuit diagrams; the chief quant thinks they are ports for some sort of distributed quantum computer, but most of the xenos think this is their actual language.
