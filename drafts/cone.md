...
We set up a workshop next to the hab to smelt, fuse, solder, program. It is fun in a routine way, the AI politely instructing, checking with the quant farm every couple of hours. Eventually we have a long-baseline polarimeter up and running and we can start taking readings.
