...
But the puzzle takes on its own life. Each stele starts like a manuscript, with a large, ornamental-looking flourish we call an initial. Stare at them long enough and motifs begin to emerge; I doodle them in my log-book to kill the time between signals. They look like hanzi mixed with circuit diagrams; the chief quant thinks they are ports for some sort of distributed quantum computer, but most of the xenos are committed to the doctrine that this is their actual language.
