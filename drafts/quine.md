...
But in fact, for a language which is [Turing complete](https://en.wikipedia.org/wiki/Turing_completeness), they are unavoidable! The reason is deep. In 1931, Kurt Gödel turned self-reference into a powerful mathematical tool with his famous [diagonal lemma](https://en.wikipedia.org/wiki/Diagonal_lemma). It says that, for 
