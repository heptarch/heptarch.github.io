...
Famously, quantum information cannot be cloned, in the sense that there is no unitary operator $U$ which copies an arbitrary state $|\psi\rangle$ onto an ancilla,
...
The basic idea is hopefully familiar: Alice wants to share a quantum state $|\psi\rangle$ with Bob, and they share a maximally entangled Bell pair,
