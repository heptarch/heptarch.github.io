...
But how hard is this targeted cascade problem? [Barrett et. al. (2003)](https://www.sciencedirect.com/science/article/pii/S030439750200395X) tell us that, in general, it is $\textsf{PSPACE}$-complete, which is complexity theory speak for "harder than $\textsf{NP}$". 
