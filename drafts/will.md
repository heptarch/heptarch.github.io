...
This is all heuristic; what can we rigorously say about the difficulty of this targeted cascade variant? The closest analogue is *dynamical system reachability*, where we think of the information diffusion step as forming a dynamical system on the graph. [Barrett et. al. (2003)](https://www.sciencedirect.com/science/article/pii/S030439750200395X) inform us that these sorts of problems are, in general, $\textsf{PSPACE}$-complete, meaning that any problem that takes polynomial space (but arbitrary time) to solve can be reduced to this one. This is believe to be a much harder class of problems than $\textsf{NP}$! 
