...
mathjax: true
comments: true
title: "Sparse autoencoding and the Donoho-Tanner crossing"
short: "SAEPage"
date:  2026-03-08
---
...
what looks like universality in the behaviour of recoverability and suggest guidelines for SAEs in practice.
...
varying $\rho\in \lbrace 0.05,0.10,0.20\rbrace$. Here are the plots:
...
in FISTA, we can outperform LASSO decoding and hit $\text{SRA}
...
This post was developed in collaboration with Claude (Sonnet 4.6),
which contributed to experimental design, numerical implementation,
