...
<input type="checkbox"
       ...
       class="margin-toggle"/>
	   <span class="sidenote">
	   This is not watertight, since we need to bound integrals of the
	   correction to our asymptotic formula for $\pi(x)$. But it's
...
than go through these, however, I want to finish with Kac's heuristic proof,
which is the crowning gem of his
[gorgeous book on probabilistic methods](https://store.doverpublications.com/0486821587.html).
