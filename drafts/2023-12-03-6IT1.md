...
intensity $I_{\odot}$ of the sun.<label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
       id="sn-1"
...
wavelength of $\lambda^* = 470 \text{ nm}.$
</div>
...
This is relatively close to the effective perceived wavelength
...
uses all that ocular physiology we don't!
Evidently, a few nanometers can still make big difference to perceived color.

<figure>
    <div style="text-align:center; padding: 5px"><img src
    ="/img/posts/sky4.svg" width="250"/>
	</div>
	</figure>
