...
(\omega/J)^2} = \frac{M}{2L}\sqrt{1 - \left(\frac{M}{J}\right)^2} +  \frac{J}{2L} \, \sin^{-1}\left(\frac{M}{J}\right).
$$
...
This is what we expect! In general, we can solve numerically, for
instance, when $K = 20 \times 10^{-3}$, $r \approx 0.95$.
