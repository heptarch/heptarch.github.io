...
In our simulation, natural frequencies are uniformly distributed
according to $g \sim \mathcal{U}(-0.01, 0.01)$. Thus, $g(0) = 1/0.02$,
and for large $N$, the onset of partial synchronization should occur
at $K_c \sim 13 \times 10^{-3}$. You should be able to see this in the
simulation!<label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
       id="sn-1"
       class="margin-toggle"/>
	   <span class="sidenote"> Although it makes this calculation
	   easy, we can't calculate $r$ because $g$ is constant.
	</span>
