...
(nominally six) in science and technology every fortnight or so. These
may be papers, discoveries, or shower thoughts; six may still end up
...
is very fiddly, and gives rise to constructions like the following
($n=40$ walls with $(n+2g)/3 = 14$ guards) which would not look out of place
in a basilica or medieval fortress:
...
On reflection, perhaps it's not surprising that supervising groups of children
