...
it gives us answer which is astoundingly close to the official one.
...
The explanation turns out to involve a completely novel physical
process: the fact that atsmopheric ozone ($O_3$)
[absorbs](https://en.wikipedia.org/wiki/Chappuis_absorption) red,
