...
The Book proof uses induction, but here's a little variant I
 ...
 on. The coloring exists and is unique up to the choice of
...
Finally, we now simply select one of the colors to be the location of
our guards! We'll choose green, like we did above:
