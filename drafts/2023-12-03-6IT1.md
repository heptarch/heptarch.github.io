...
<input type="checkbox"
       ...
       class="margin-toggle"/>
	   <span class="sidenote">
	   Fireflies also wander randomly in space, but this is for aesthetic effect only and unrelated to the flashing.
	   </span>
...
\]
where $re^{i\psi} = \sum_{j=1}^{N}e^{i\theta_j}$ is the mean
...
<div style="background-color: #16171c ; padding: 20px 20px 0px 20px; border: 0px solid
grey; line-height:1.5">
<details>
  <summary>
   <i>Calculation.</i>$\,$ (Summary: couple to the mean field, turn
...
at $K_c = 0.04/\pi \sim 13 \times 10^{-3}$. You should be able to see this in the
...
<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/firefly3.svg" width="330"/>
	</div>
	</figure>

The usual image of chaos is the *butterfly effect*, where systems become
unpredictable due to sensitivity on initial conditions. I like to
think of the "firefly effect" as a converse; due to chaos, predictable
behaviour emerges spontaneously, and is remarkably insensitive to initial conditions!
