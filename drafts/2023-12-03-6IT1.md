...
<div style="background-color: #202229 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<span style="font-variant: small-caps">Solar Adaptation.</span>
If the sensitivity curve of the eye perfectly matches, the sun, the
perceived color of the sky is $\lambda = 495 \text{ nm}$.
</div>
...
assumption that eye's sensitivity curve matches $B(\nu)$, the perceived
...
\]
This is blue with a green tinge, very close to what we actually see! $\blacksquare$
</div>
