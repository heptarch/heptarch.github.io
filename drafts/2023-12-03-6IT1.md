...
The proof isn't particularly transparent,<label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
id="sn-1"
class="margin-toggle"/>
<span class="sidenote"> In his book, Kac says it can be proved by “entirely
elementary means” and omits it, which smells like a synonym for “hard”. <a
href="https://www.ma.ic.ac.uk/~bin06/M34PM16-Analytic-Number-Theory/m3pm16div.pdf">Nick
Bingham's proof</a> for the case $k=2$ confirms this suspicion.
