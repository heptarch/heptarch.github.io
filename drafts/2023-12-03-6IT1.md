...
It is remarkable that that internal obstructions makes the task so
...
Baumeler, Dakić, and Del Santo seem to disagree, arguing that
the AoC may have physical implications.
They use the following

<div style="background-color: #202229 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<b>Infinite hat theorem.</b> Using the AoC strategy, 
</div>
