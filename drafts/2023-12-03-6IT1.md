...
pieces, and reassemble them to form *two* spheres of volume $V$!

<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/aoc1.svg" width="300"/>
	</div>
	</figure>
...
Richard Feynman refutes Banach-Tarski on the ground that no *physical*
sphere, composed of atoms, can be split up this way. One could view
this as a point against the AoC, but I think is more realistic to view
it as telling us that *we cannot use physics to reason about the
axioms of set theory*. The AoC could be true, it could be false;
physics has nothing to do with it.
Baumeler, Dakić, and Del Santo write 
