...
<input type="checkbox"
	   ...
	   line, and use partial fractions on the third. This integral is
	   annoying. $\blacksquare$
</div>
...
Erdős and Kac's derivation uses the formidable sieve methods of which
Erdős was a mster, and although simpler proofs now exist, we won't
