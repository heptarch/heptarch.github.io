...
discuss [here](https://hapax.github.io/physics/everyday/sky), the
approximate solution is $x \approx 5$. It's more common to consider
the wavelength of sunlight, so we have
\[
\lambda = \frac{c}{\nu} = \frac{Cc}{Tx} \approx frac{hc}{5k_\text{B}T}.
\]
</div>
