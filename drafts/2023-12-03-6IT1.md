...
6. <a href="#sec-6"><i>Quantum error correction with Penrose tilings</i></a>
...
## 6. <a href="#tbc">Quantum error correction with Penrose tilings</a><a id="sec-6" name="sec-6"></a>
