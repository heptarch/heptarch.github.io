...
[beautiful book](https://store.doverpublications.com/0486821587.html) on probabilistic methods.
...
\end{align*}
This proof isn't watertight, but it is a more rigorous way to get to
the same place. $\blacksquare$
</div>

As $n$ gets large, the distribution of prime factors forms a smooth
Bell curve around $n$. Perhaps the primes play a game of chance, as
Mark Kac put it, but in the long run the house always wins.
