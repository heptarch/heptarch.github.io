...
grey; line-height:1.5">
<i>Proof.</i> For a prime $p \leq n$, the number of sets of $k$ primes, which
...
$$
 We will give a heuristic proof by induction; for a more careful demonstration, see <a href="https://archive.org/details/introductiontoth00hard/page/n5/mode/2up">Hardy
First, the base case $k=1$ is the PNT
$(\ref{PNT})$.
Now assume it is true for $k$, and we wish to prove the case for $k+1$. Our goal to
...
make the substitution $s = \log (n/x)$ on the second
