...
\end{align*}
Thus, $\Omega(n)$ is normally distributed as claimed. $\blacksquare$
</div>

This proof isn't watertight, but it is a more rigorous way to reach
the same conclusion.
Kac said that the primes play a game of chance; maybe so, but their
strategies are eventually predictable.
