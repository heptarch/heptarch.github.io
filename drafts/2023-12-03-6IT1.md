...
invariant*, so $|T\rangle$ should be considered the same as
$|gT\rangle$.
...
*boundary neighbourhood* of $K$ will do!
This is simply because we extend the Ammann lines and complete, as above.
