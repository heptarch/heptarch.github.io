...
not, which raises more questions...<label for="sn-1"
       class="margin-toggle sidenote-number"></label>
<input type="checkbox"
       id="sn-1"
       class="margin-toggle"/>
	   ...
	   twilight, which is determined primarily by ozone, but also
	   (they conclude) aerosol, haze, and high-altitude meteorology.
