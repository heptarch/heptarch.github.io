...
<input type="checkbox"
	   ...
	   is a sort of <a href="https://en.wikipedia.org/wiki/Error_correction_code">error correcting code</a>, robust against any finite
	   number of errors. So far, there seems to be no practical use,
	   since although the errors do not spoil the code, they do spoil its
	   intended applications to communication or prediction.
	   </span>
