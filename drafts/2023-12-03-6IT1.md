...
repetition, we have
\[
k! \tau_k(n) \leq \Pi_k(n) \leq k! \pi_k(n) \leq k! n.
\]
...
Erdős and Kac's derivation uses the difficult sieve methods, of which
Erdős was a master, and although simpler proofs now exist we won't
