...
coupling, $M = L \ll J$, keeping only first-order terms in $L/J$,
...
as expected! One of the reasons I love these fireflies is because, in
contrast to the usual image of chaos as
sensitivity to initial conditions, aka the *butterfly effect*, we have
here the spontaneous emergence of predictable behaviour, precisely in
the chaotic regime!
