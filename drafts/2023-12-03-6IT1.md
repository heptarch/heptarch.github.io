...
This is boring! Let's think about how to couple the oscillating bugs.
...
simulator, where you can control the normalized coupling $K = kN$ and the
number of fireflies $N$. Just click and drag, left/right for coupling
and up/down for number:

<div id="sketch-holder"></div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.4.0/p5.js"></script>
<script src="/assets/fireflies_data/firefly1.js"></script>

Natural frequencies and starting phase are randomized
...
synchronization*, that is, periods of sustained nonzero coherence,
though these periods themselves oscillate in a fashion characteristic
of chaos, like the
...
We solve this for the large-$N$ limit in the box below.

<div style="background-color: #202229 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<span style="font-variant: small-caps">Kuramoto Oscillators in the
Large-$N$ Limit.</span> For a polygonal gallery of $n$ walls, $\lfloor
n/3 \rfloor$ guards are sufficient.
</div>
