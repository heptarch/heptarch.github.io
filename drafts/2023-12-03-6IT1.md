...
To make this a bit more concrete, consider
...
$2$-coloring of vertices of tesseract, or
equivalently, coloring the faces of its dual object, the
[16-cell](https://en.wikipedia.org/wiki/16-cell).
Our symmetry is antipodal symmetry, though not every coloring appears
in the code space, e.g. $0001$.
...
<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/qecc3.svg" width="180"/>
	</div>
	</figure>

I suspect there is a nice way to generalize this. The other question
is how this relates to
[holography](https://en.wikipedia.org/wiki/AdS/CFT_correspondence),
which Li and Boyle touch on.
It is [known](https://arxiv.org/abs/1411.7041) that, in some ways,
quantum gravity behaves like a QECC, in particular physical
information is encoded globally in a redundant.
