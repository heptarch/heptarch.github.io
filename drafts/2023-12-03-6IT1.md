...
This demon can use the AC, and has a set of lucky coins; any time it
...
<div style="background-color: #202229 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<span style="font-variant: small-caps">Hardin-Taylor Theorem.</span>
...
sequences, and choose the representative $s_i$ via the AC. The question is
...
The fact that Zermelo's demon cannot do anything spooky with respect
to future coin flips makes it seem less physically relevant.
