...
than thoroughh and technically deep; more pop than classical. Let's see how it goes!
...
that $\lfloor n/3 \rfloor$ guards are sufficent.<label for="sn-1"
...
<input type="checkbox"
       ...
       class="margin-toggle"/>
	   <span class="sidenote">
	   This wonderful book, by Martin Aigner and Günter Ziegler,
	   presents proofs so elegant that God themself might
