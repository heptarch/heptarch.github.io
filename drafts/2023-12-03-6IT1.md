...
<details>
  <summary>
<i>Proof.</i>$\,$ (Short version: the demon uses the same trick as the
prisoners, with functions rather than sequences.)
  </summary>
  <p>
...
<details>
  <summary>
<i>Calculation.</i>$\,$ (Short version: take a product of spectra and
sensitivity curves, differentiate, and set to zero.)
  </summary>
  <p>
...
induction, and perform a horrible integral.)
  </summary>
  <p>
...
This isn't watertight, but it adds a touch of rigor to our
semi-empirical arguments above.
