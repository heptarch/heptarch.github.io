...
can use the behaviour of $f$ on $(-\infty, t_0)$ to correctly predict the
behaviour on $(-\infty, t_1)$ for some $t_1 > t_0$, except for $t_0$
...
The set of "unforseeable" times is
$$
