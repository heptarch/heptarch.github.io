...
This is a bit reminiscent of Maxwell's demon and variants, so let us
replace the prisoners with *Zermelo's demon*, after Ernst Zermelo, who
invented the AoC.<label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
       id="sn-1"
       class="margin-toggle"/>
	   <span class="sidenote">
	   In fact, Zermelo already has a demon associated with the
	   [Poincaré recurrence theorem](https://en.wikipedia.org/wiki/Poincar%C3%A9_recurrence_theorem),
	   but we suppose this demon tired of thermodynamics and moved on.
	   </span>
This demon can use the AoC, and has a special ability; when it picks
up coins, it can sense the history of their flips, as well as how many
more flips may be made before the coin distintegrates due to wear and tear.

To connect this result to physics, Baumeler, Dakić, and Del Santo note
that it violates "functional no-signaling", 
Generalizations of this problem are studied at length in
[Hardin and Taylor's monograph](https://qcpages.qc.cuny.edu/~rmiller/abstracts/Hardin-Taylor.pdf). Perhaps
the most surprising is a theorem, also
[due to Hardin and Taylor](https://www.jstor.org/stable/27642415),
that we can we predict the value of an 
