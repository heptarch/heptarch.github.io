...
5. <a href="#sec-6"><i>Neural scaling from fundamental physics</i></a>
...
unpredictable due to sensitivity on initial conditions, or put
differently, from a small patch of phase space to large patch (when
...
## 6. <a href="#tbc">Galactic black hole AGI</a><a id="sec-6" name="sec-6"></a>
...
the operation of the black hole computer due to the laws of physics;
...
Let's review the black hole bounds first.
