...
sun's temperature. Using the fact that the ratio of direct to diffuse
sunlight is $85 : 15$, so $\alpha = 0.85$, this gives
\[
\lamda^* \approx 470 \text{ nm}.
\]
</div>
...
\]
very close to the effective perceived color.
$\blacksquare$
</div>
