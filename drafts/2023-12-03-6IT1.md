...
<details>
  <summary>
<i>Proof.</i>$\,$ (Summary: prisoners see eventually identical
...
phasor. We picture the probability distributions over phase below:
...
If the distribution of natural frequencies $g(\omega) = g(-\omega)$ is
