...
</span> but the idea is that $\pi_k(n)$ counts the number of sets of
$k$ primes, less than $n$, whose product is also less than $n$. Let
$P_n$ denote the set of primes less than or equal to $n$. Then

$$
\pi_k(n) = \left\{A \subseteq P_n : |A| = k, \,\,\prod A < n\right\}.
$$
