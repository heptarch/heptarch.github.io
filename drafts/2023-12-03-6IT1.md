...
$\{S_i\}_{i\in I}$, we can choose a set of representatives
$\{s_i\}_{i\in I}$, where $s_i \in S_i$.
This seems very reasonable—it is basically the requirement that we can
select a member of a nonempty set—
