...
with the yet-to-be-observed outcomes $s(k)$.
But since any set of such outcomes $\{\text{T}, \text{H}\}^n$ is consistent with this same choice
of $s_i$, by symmetry, we learn nothing about those flips.
$\blacksquare$
</div>
