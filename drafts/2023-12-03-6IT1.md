...
= 4L/\pi$. We can also calculate $r$. Setting $J = Kr$,

$$
r = \int_{|\omega| \leq \min\{L, J\}} \mathrm{d}\omega \,\, \sqrt{1 -
(\omega/J)^2} = \frac{2}{J}\sqrt{1 - \min\{L, J\}^2}\min\{L, J\} + 2\sin^{-1}\left(\frac{\min\{L, J\}}{J}\right).
$$
