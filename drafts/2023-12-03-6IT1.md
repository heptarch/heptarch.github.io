...
guarantees about how long that claivoyance can last. It would be
unwise to follow its investment advice! As with the lucky coins, the
demon's powers are somewhat useless. In fact, in all the variants discussed in Hardin and
Taylor's
[monograph](https://qcpages.qc.cuny.edu/~rmiller/abstracts/Hardin-Taylor.pdf)
suffer from some similar constraint:
