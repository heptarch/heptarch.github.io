...
cutely observe that this looks a lot like a quantum error-correcting
code (QECC)!
...
The expectations of observables should be unaffected by errors in a
specified set.

<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/qecc1.svg" width="300"/>
	</div>
	</figure>
