...
simulator, where you can control the normalized coupling $K = kN$ with *a/d* and the
number of fireflies $N$ with *s/w*:
...
<input type="checkbox"
       ...
       class="margin-toggle"/>
	   <span class="sidenote">
	   In fact, this is a second-order phase transition! You can see
	   this by 
	   </span>
