...
blue below), opening at angles $2\pi/5$ and $\pi/5$ respectively.
To build a tiling, we join kites and darts according to matched edges,
indicated by a single or double arrowhead below:

<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/penrose1.svg" width="400"/>
	</div>
	</figure>

There are uncountably many ways to perform the matching, but it has 
