...
<figure>
    ...
    ="/img/posts/guards1.svg" width="350"/>
	</div>
	</figure>
...
grey; line-height:1.5">
<b>Proof.</b> Consider the graph formed by the $n$ walls of the gallery, with
...
The Book proof uses induction, but here's a little variant I
 came up with. Note that, since there are no internal vertices, the
 triangular faces 
■
 </div>
