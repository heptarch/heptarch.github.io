...
<details>
  ...
  <p>
  We will first show <i>local recoverability</i>, i.e. that the pattern in
  a finite region $K$ can be recover from the pattern in $K^c$.
...
<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/penrose3.svg" width="300"/>
	</div>
	</figure>

	The pattern can be uniquely reconstructed from the Ammann lines,
...
[Latham and Boyle (2023)](https://arxiv.org/pdf/2311.13040.pdf)
