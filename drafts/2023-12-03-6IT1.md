...
was proven independently by Jacques Hadamard and Charles Jean de la
Vallée Poussin in 1896.
Hadamard also proved a beautiful generalization. Let $\pi_k(n)$ count
...
\]
Let's now apply it to Hadamard's binomial process $(\ref{PNT+})$,
where we write
\[
...
<input type="checkbox"
       ...
       class="margin-toggle"/>
	   <span class="sidenote">
	   It is heuristic because we need to control the errors in
