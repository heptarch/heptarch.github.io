...
coupling, $M = L \ll J$, we get

$$
r \approx \frac{1}{2}\left(1 - \frac{L^2}{2J^2}\right) +
\frac{1}{2} \left(1 + \frac{L^2}{6J^2}\right) = \frac{1}{2}\left(1 - \frac{L^2}{3J^2}\right),
$$

using the binomial expansion and the Taylor series of $\sin^{-1} x$.
