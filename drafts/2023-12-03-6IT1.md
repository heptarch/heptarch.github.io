...
make the substitution $s = \log (n/x)$ in the second
line, and $t = \log s$ in the third.
This can be evaluated, using computer algebra or by hand, in terms of
the <a
href="https://en.wikipedia.org/wiki/Polylogarithm">polylogarithm</a>,
to find
\begin{align*}
...
\[
\pi_{k+1}(n) \sim -\frac{1}{(k-1)!}\frac{n}{\log n} \text{Li}_{k}\left(\frac{\log n}{\log 2}\right)\right]
\sim 
\]
$\blacksquare$
</div>
