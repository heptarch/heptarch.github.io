...
3. <a href="#sec-3">Why the sky is blue</a>
4. <a href="#sec-5">A normal number of prime factors</a>
...
How many prime factors is normal? I had occasion to consider this
problem recently, and discovered the remarkable theorem of Erdős–Kac
to the effect that, as $n$ gets large, the number of primes factors of
