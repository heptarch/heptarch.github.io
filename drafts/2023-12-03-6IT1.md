...
\ldots, N$, whose brightness naturally oscillates with frequency $\omega_i$.<label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
       id="sn-1"
       class="margin-toggle"/>
	   <span class="sidenote">
	   I don't think brightness is really sinusoidal, but rather an
	   oscillator multiplied by some cutoff, which I've included in
