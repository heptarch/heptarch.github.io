...
\[
\lambda^* = \frac{14.39 \text{ mm}}{\beta (1- e^{-\beta}) 5772} \approx 473 \text{ nm},
\]
...
it gives us an answer which is astoundingly close to the official one: $\lambda = 475 \text{ nm}$.
...
uses all that ocular physiology we ignore.
