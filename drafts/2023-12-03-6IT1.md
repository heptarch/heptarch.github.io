...
$$
 We give a heuristic argument from induction; for a more careful
 demonstration, see <a
...
Assume it is true for $k$; we will use this to deduce the result for $k+1$. Our goal to
...
The first term integrates to give what we want, up to subleading terms
we discard. The second integral can be expanded 
$\blacksquare$
</div>
