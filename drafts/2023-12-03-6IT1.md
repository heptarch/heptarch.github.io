...
scattered light, so a more refined approximation is that sensitivity
is a weighted average, $V = \alpha I_{\odot} +
\beta I_{\text{diff}}$ for some $\alpha + \beta = 1$.
