...
that, for $|u\rangle, |v\rangle \in \mathcal{H}_0$ and any errors
$\mathcal{E}_i, \mathcal{E}_j$,

$$
\langle u | v\rangle = 0
\quad \Longrightarrow \quad
\mbox{Tr}[(\mathcal{E}_i\circ \mathcal{U}|u\rangle)^\dagger (\mathcal{E}_j \circ \mathcal{U})|v\rangle)].
= 0,
$$

This all seems a bit complicated, but for the Penrose tiling QECC
