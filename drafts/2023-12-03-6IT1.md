...
\[
\lambda^* = \frac{14.39 \text{ mm}}{5772\beta (1- e^{-\beta}) } \approx 473 \text{ nm},
\]
...
it gives us answer which is astoundingly close to the official one: $\lambda = 475 \text{ nm}$.
...
yellow of sunset; the former is because there is no sunlight to
scatter, and the latter because most of the blue has been scattered out of
the light. But the blue band in between doesn't make sense!
...
[Chappuis absorption](https://en.wikipedia.org/wiki/Chappuis_absorption)
