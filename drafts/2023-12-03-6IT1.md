...
I think physics remains safe from Zermelo's demon.<label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
       id="sn-1"
       class="margin-toggle"/>
	   <span class="sidenote">
	   Even if Zermelo's demon isn't good at predicting the future, it
	   does illustrate a method for creating error-correcting codes, r
	   </span>
