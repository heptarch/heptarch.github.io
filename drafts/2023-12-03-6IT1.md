...
$\theta_i$ tends to slow down if it is ahead of $\theta_i$, and speed
up if it lags.
...
This has the same mathematical form as friction, with $k$ a sort of
coefficient of friction between firefly $i$ and $j$.
