...
As a sanity check, note that the variance of a Poisson-distributed
       variable equals the mean. We can plot the sample variance for
       data points and see how it compares:
...
As $n$ gets larger, they become closer. <label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
       id="sn-1"
