...
*internal polygons*; we draw one above.
...
But we can modify our earlier examples by adding walls, which we have
...
Although this extension is cute, useful
applications to OSH care require a full panoply: exterior regions
afforded by windows, finite field
...
- [*Proofs from THE BOOK*]
  (https://link.springer.com/book/10.1007/978-3-662-57265-8) (1998), Martin Aigner and Günter Ziegler.
