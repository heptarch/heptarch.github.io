...
<i>Exercise 1.1.</i> Show that a gallery with $n$
...
For instance, the following OSH layout has $n = 7$ and $g = 1$:
...
Adding more slits and more recesses, we can show necessity for
arbitrary values of $n$ and $g$.
All this is rather cute, but 
