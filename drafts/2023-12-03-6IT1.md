...
Basically, a pair of ozone molecules can absorb photons, wobble a bit,
then split into three oxygen molecules,
\[
2\text{O}_3 + \gamma \to 3\text{O}_2.
\]
The details of the process are messy, 
