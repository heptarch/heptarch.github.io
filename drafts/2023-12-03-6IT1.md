...
<input type="checkbox"
	   ...
	   but we suppose this demon tired of thermodynamics.
	   </span>
This demon can use the AoC, and has a set of lucky coins; when it
flips such a coin, it learns the (infinite) his
