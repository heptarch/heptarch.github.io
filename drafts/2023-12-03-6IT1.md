...
\tag{3} \label{PNT+}
\]
for $\lambda = \log\log n$. This matches a Poisson distribution with
parameter $\lambda$.
</div>

<div style="background-color: #16171c ; padding: 20px; border: 0px solid
grey; line-height:1.5">
<i>Proof.</i> We will give a heuristic proof by induction; for
some of the details we're missing, see <a
...
<input type="checkbox"
	   ...
	   line, and use partial fractions on the third. $\blacksquare$
</div>
