...
Chappuis bands) can be absorbbed.
...
No wonder if the sunset colors disappear so quickly!
What's left over is the blue light not yet scattered.
You might wonder if the hole in the ozone layer leads to less blue at twilight. As
...
not. Something else is at play; with atmospheric optics, it seemingly
always is.
