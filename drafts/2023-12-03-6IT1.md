...
guess it is everyone's lumpy, skewed favorite, the
[Poisson distribution](https://en.wikipedia.org/wiki/Poisson_distribution).
To check, we note that characteristic feature of the distribution is
that the mean and variance agree. Plotting the variance
