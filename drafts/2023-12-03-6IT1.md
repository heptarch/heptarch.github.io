...
care. Instead of guards, there are educators, and unlike paintings
which stay in specific locations on the wall, children are mobile and
unpredictable, so the requirement of full visibility makes sense!
My sister coordinates an OSH facility with an almost comically complex
layout.
A crucial difference from the standard art gallery theorem is the
existence of *internal walls*, which obscure visibility in the
space. This leads to the requirement of additional 
...
a vertex on the outer polygon. If each such edge is viewed as
