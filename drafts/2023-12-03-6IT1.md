...
$\\{s_i: i\in I\\}$, where $s_i \in S_i$.
Though this is very intuitive—we can select elements from nonempty
...
which uses the AoC to split a (perfect) sphere of volume $V$ into five
