...
grey; line-height:1.5; border-radius: 15px">
<sc>Art gallery theorem.</sc> For a polygonal gallery of $n$ walls, $\lfloor
...
"experiment", we cannot use physics to reason about the axioms of set
theory. The AoC could be true, it could be false; physics probably has
nothing to do with it.

Baumeler, Dakić, and Del Santo seem to disagree.
The argue that the AoC may have physical implications, information no
less, using the following bizarre consequence:

<div style="background-color: #202229 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<b>Infinite hat theorem.</b> Suppose prisoners are placed on the
...
<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/aoc2.svg" width="300"/>
	</div>
	</figure>

If the prisoners are allowed to meet beforehand, and can use the AoC,
they can guess the color of their hats so that <i>only a finite number
are wrong</i>.
</div>
