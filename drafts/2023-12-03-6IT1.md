...
planning to blog about a few different "finds"
(nominally six) on a semi-regular (nominally monthly) basis. These
...
Given that it exists, we either draw a triangle with the two
