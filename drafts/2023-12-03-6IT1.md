...
1. <a href="#sec-1"> Art galleries and OSH care</a>
...
## 1. Art galleries and OSH care<a id="sec-1" name="sec-1"></a>
...
<input type="checkbox"
	   ...
	   collect demonstrations so elegant that God themself might
...
**Exercise 1.** Use similar reasoning to show that a gallery with $n$
...
care, where the requirement of full visibility is much more sensible
than an art gallery. My sister coordinate an OSH facility with a
layout so complex it literally invited mathematical analysis. One
difference from the standard art gallery theorem is the existence of
*internal walls*.
