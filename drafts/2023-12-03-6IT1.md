...
coin flips makes it seem less physically disturbing. But there is
...
Given an arbitrary function $f:\mathbbb{R} \to \mathbb{R}$, Zermelo's demon
...
$$
f \sim_t g \quad \Longleftrigharrow f(x) = g(x) \text{ for all } x
\leq t.
$$
$\blacksquare$
</div>
