...
If we plot the average value of $\omega(n)$ against $\log \log n$, we
find an almost perfectly straight line with unit slope!
...
Our guess seems to be on the money! A second observation is that
