...
1. <a href="#sec-1"> Art galleries and aftercares</a>
...
## 1. Art galleries and aftercares <a id="sec-1" name="sec-1"></a>
...
The coloring exists and is unique up to the choice of
...
We choose this rare color to be the location of our guard. Since each
triangle has a vertex of this color, each triangle is covered, and we
are done. ■
</div>

---

As Aigner and Zeigler discuss, there is a subtlety with the existence
of the required triangulation for non-convex polygons. To deal with
it, we can use induction on the size of the graph, and the existence
of a vertex with acute interior, like the leftmost vertex in our
example above. If no such vertex existed, the polygon could never
