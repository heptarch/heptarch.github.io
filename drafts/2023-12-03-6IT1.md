...
<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/guards5.svg" width="450"/>
	</div>
	</figure>
...
general $n$ and $g$, I believe the problem is unsolved, and even the
characterization for $g = 1$ due to Shermer is rather complicated.
But the smallest known example
