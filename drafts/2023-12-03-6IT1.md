...
$$
I'll give original but not entirely rigorous argument from induction; for a more careful
proof, see <a
...
make the substitution $s = \log (n/x)$ in the second, and $t = \log s$ in the third.
