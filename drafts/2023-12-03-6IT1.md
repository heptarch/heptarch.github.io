...
But we can observe that when $\theta_j \approx \theta_i$, the linear
term is approximated by $\sin(\theta_j - \theta_i)$, and whatever the
phase difference, this is bounded by $1$. This suggests we try
