...
6. <a href="#sec-6"><i>Correcting quantum computation with Penrose tilings</i></a>
...
<figure>
    <div style="text-align:center; padding: 15px"><img src
    ="/img/posts/firefly3.svg" width="350"/>
	</div>
	</figure>
...
## 6. <a href="#tbc">Correcting quantum computation with Penrose tilings</a><a id="sec-6" name="sec-6"></a>

I recently started reading the
[review](https://arxiv.org/pdf/2205.02867.pdf) by Richter et al. on
semiclassical chaos. One of the coolest things in this review is a
connection between spectral chaos and the braiding of semiclassical
orbits; I'll discuss what this means, and a few other fun things like
the Gutzwiller trace formula, along the way.

### References

- *Chaos in Classical and Quantum Mechanics* (1990), Martin Gutzwiller.
-  ["Semiclassical roots of universality in many-body quantum chaos"](https://arxiv.org/pdf/2205.02867.pdf)
  (2022), Klaus Richter, Juan Diego Urbina and Steven Tomsovic.
