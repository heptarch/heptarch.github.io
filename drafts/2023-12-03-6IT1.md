...
There are a dizzying variety of generalizations, studied at length in Hardin and Taylor's
[monograph on the topic](https://qcpages.qc.cuny.edu/~rmiller/abstracts/Hardin-Taylor.pdf),
though. Perhaps
the most surprising is the [Hardin-Taylor theorem](https://www.jstor.org/stable/27642415).<label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
       id="sn-1"
	   ...
	   <span class="sidenote">
	   I found
	   [Eric Moorhouse's](https://ericmoorhouse.org/handouts/Hardin-Taylor.pdf)
	   writeup a bit more approachable.</span>
