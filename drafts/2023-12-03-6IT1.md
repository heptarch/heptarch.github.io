...
<figure>
    <div style="text-align:center; padding: 5px"><img src
    ="/img/posts/prime3.svg" width="300"/>
	</div>
	</figure>

Although we have sloppy, this statement can be rigorously proven; it is called the
...
grey; line-height:1.5">
<i>Proof.</i> First, consider a Poisson variable
