...
roughly $nk_B T \ln 2$, since after we start erasing bits but continue
computing reversibly, the entropy generated by erasure and the entropy
saved should balance out.
