...
This is consistent with the spectral decomposition (see e.g. [this doctoral thesis](https://eprints.lib.hokudai.ac.jp/repo/huscap/all/64438/Hideaki_Konno.pdf), Figure 3.5) of a whisper, which is usually perceived in the $10^3$–$10^4 \text{ Hz}$ range. 
