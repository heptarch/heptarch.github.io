...
This is consistent with the spectral decomposition (see e.g. [this doctoral thesis](https://eprints.lib.hokudai.ac.jp/repo/huscap/all/64438/Hideaki_Konno.pdf), Figure 3.5) of a whisper, which is usually perceived in the $10^3$–$10^4 \text{ Hz}$ range. Technically, there is a probability distribution over leaf size and hence frequency, but this complicates the analysis without shifting the result. This leaves us we have a nice first-principles account of why trees whisper when the wind blows!
