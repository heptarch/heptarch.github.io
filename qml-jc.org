...
|--------------+---------------+---------------+---------------|
| [[week0][Jan 9]], 2024  | Admin         | David Wakeham | David Wakeham |
...
also be a scribe to take notes (in [[https://orgmode.org/worg/org-syntax.html][~org mode~]] or anything else [[https://pandoc.org/][~Pandoc~]] can handle).
...
*Reading*: [[SVM][SVM]]: §1.1-2; [[ESL][ESL]]: §2.1-2.4. *Homework*: TBA.
