...
mathjax: true
comments: true
title: "Reflections on Bell Labs: Part 1"
date:  2024-01-17
---
...
Money, to begin with. Bell Labs operated
...
personnel or the supply of oscilloscopes—but philosophical. This essay
explores that philosophy in a little more detail.

## 1. <a href="#toc">The Kelly gang</a><a id="sec-1-1" name="sec-1-1"></a>

The idea of an "institute of creative technology" comes from Mervin Kelly, director
       of research and later president of Bell Labs.<label for="sn-1"
...
research." An ill-framed objective might
distract from their real job.

Of course, to meet the technical needs of a giant like Bell, someone
...
security, more on-paper freedom, more vertiginously soaring ivory tower, than one could poke a
tenured chair at.
...
The IAS is too far away to have an impact on reality.
...
researchers would use their freedom to obey [Paul Graham's dictum](https://paulgraham.com/startupideas.html): “live in the future, then build what's
missing".
...
In contrast, if you're put on a team with a provocatively hard domain of
...
information theory and modern cryptography single-handed; what gives?
Another Bell luminary, Richard Hamming, viewed openness as the key
criterion rather than collaborativeness per se: "there is a pretty good correlation between those who
...
That openness is how collaboration and discovery happens. Shannon may have been a lone
...
to have a foot in both worlds. That would be the director of research.
...
Putting it all together, we have a preliminary recipe for creative applied research.
...
Money and freedom aren't enough; you need a mission.

You might conclude pessimistically that Bell Labs' mission---to help
build a nation-wide telecommunications infrastructure---and the
...
relies on ready revenue and ROI-haunted venture capital to stay afloat.
The moonshot factories like `X` are perhaps too disconnected from the
...
but in isolation. Part of the magic of Bell was in the scale and
...
of which talk to most of the others. Then the number of connections scales
as $O(n^2)$. If profitable connections are distributed at random along
...
it seems like OpenAI's structural quirks are part of what
makes it special.
...
2. *Security.* This one is trickier. As we've discussed above, in tech, stable funding is hard to come by, and in most universities,
   even tenure is no guarantee of money. But this is
   where separation of concerns becomes important; the researchers
   should not be the ones hustling for grants, or developing and selling
...
light on how to generalize that algorithm for herding sheep? By all means. Managers shouldn't
try to control the outcome, but to nurture and guide the process.
...
8. *Management.* If researchers are encouraged to focus and become
   ...
   and vision, the insight of scientist-managers like Kelly. Then
   again, as grumpy
   ...
   management, and some in between. Industry has the unexpected
   luxury of choosing people for the roles they are best
   at.
...
9. *Talent.* Kelly emphasized the importance of quality hires, of recruiting
   ...
   knack to scouting, building, and managing teams for scientific
...
But I wonder if it's simply unpopular because it usually means large capital outlays 
on unpredictable outcomes like lasers that benefit everyone, including your
competitors.
...
Let's try following the recipe we worked so hard to reverse engineer.
...
for coordinating different strands of research to ensure that the
different voices harmonize, like an orchestra conductor (*management*). Ideally, this
...
don't have to (*separation*), and knows how to work the
...
both be whoever kickstarted the whole shebang.

All this may seem quixotic, but it's analogous to the common model of
open-source software. Coders around the world come
...
software and what I'm describing is probably (a) the important of who
is in the team, and (b) the sustained mental effort. I *hope* I'm
being chauvinistic about both of these, because if I am, it means "open-source science"
...
Another very encouraging example is the
[Polymath Project](https://en.wikipedia.org/wiki/Polymath_Project) in
pure mathematics.

So, this essay has really been a lengthy preface to a sales pitch: why
not try the Bell Labs model in an open-source setting?
I call this `Rebel Labs` for obvious reasons.
<!-- I've put some example projects on the [lab](/lab) page; these are -->
<!-- all things I am tentatively working on, and will add more details soon. But the point is, the projects will be a lot better if smart -->
<!-- folks take interest and get involved!--> I don't think we'll invent the laser,
but then again, Bell Labs shows that collaborative research synergy is
at least as powerful as coherent light.
