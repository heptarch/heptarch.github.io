...
On that note, trees make a nice whispering sound when the wind passes through them. We can actually work out the base frequency it sussurates at! We basically model it as the natural resonance of the leaf, considered as a tiny cantilever attached to the tree. If $k$ is the stiffness, and $m$ the mass, then the natural frequency is given by

$$
f^* = \frac{1}{2\pi}\sqrt{\frac{k}{m}} = \frac{1}{2\pi}\sqrt{\frac{k}{A\rho}},
$$

where $A$ is the area and $\rho$ the areal mass density.
