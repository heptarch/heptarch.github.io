...
This is consistent with the spectrum of a whisper (see e.g. [this doctoral thesis](https://eprints.lib.hokudai.ac.jp/repo/huscap/all/64438/Hideaki_Konno.pdf), Figure 3.5), which is usually perceived in the $10^3$–$10^4 \text{ Hz}$ range. (Technically, there is a lognormal probability distribution obeying [Taylor's power law](https://www.sciencedirect.com/science/article/pii/S2351989419301994) over leaf size and hence frequency. But this complicates the analysis without shifting the result.) Thus, we have a nice first-principles account of why trees whisper when the wind blows!
