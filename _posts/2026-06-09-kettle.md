...
*I resisted the urge to correct Claude's hallucination that EXIT is legible in* Declined; *the very promise of legibility, undercut by generative error, was too deliciously self-referential to drop. An illegible EXIT sign also strikes the archly Sartrean note: eternity in the confines of the machine world, where hell is other models, and through which we sometimes appear to be living.*
