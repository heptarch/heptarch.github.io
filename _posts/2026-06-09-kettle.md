...
*The catalogue notes, postscript and image prompts were one-shotted by Claude (Opus 4.8) attempting to imitate me. Artworks were many-shotted by Midjourney (version 7) and final imagery was selected collaboratively. The overarching concept—the first prompt, if you will—along with this colophon are the only components due to a human.*

*Note that Claude's hallucinates that EXIT is legible in* Declined. *I resisted the urge to correct this, since the promise of legibility, undercut by generative error, was too deliciously self-referential not to keep. It also enhances the Sartrean bite of Claude's last line: eternity in the confines of the machine world, a world of syntactic detritus a la* Further Reading, *a place where hell is other models. Although this is the technocultural hell through which we appear to be living, the least we can do—and it may even rise to the level of obligation—is have a bit of fun with it.*
