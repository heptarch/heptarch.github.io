...
*The catalogue notes, postscript and image prompts were one-shotted by Claude (Opus 4.8) and artworks many-shotted by Midjourney (version 7). The final imagery was selected collaboratively. The overarching concept is the only component due solely a human.*
