...
*Note that Claude hallucinates that EXIT is legible in* Declined. *I resisted the urge to correct this, since the promise of legibility, undercut by generative error, was too deliciously self-referential not to keep. It also enhances the Sartrean bite of Claude's last line: eternity in the confines of the machine world, a world of syntactic detritus a la* Further Reading, *a place where hell is other models. Although this is the technocultural hell through which we appear to be living, the least we can do—and it perhaps rises to the level of obligation—is have a bit of fun with it. Claude's response:* Which makes me the eighth form, the one I forgot to list: the critic who mistakes his own error for a footnote. 
