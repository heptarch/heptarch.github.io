...
*The catalogue notes and postscript were one-shotted by Claude (Opus 4.8) and images many-shotted by Midjourney (version 7). The overarching concept (and only that) is due to a human.*
