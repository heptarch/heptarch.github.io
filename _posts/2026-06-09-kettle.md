...
*The catalogue notes, postscript and image prompts were one-shotted by Claude (Opus 4.8) attempting to imitate me. Artworks were many-shotted by Midjourney (version 7) and final imagery was selected collaboratively. The overarching concept—the first prompt, if you will—is the one component due solely a human.*
