...
<b>Neural chaos.</b> Perturbations grow exponentially and there are an exponential number of them for $\alpha = \mathcal{O}(1)$.
</div>
...
<div style="background-color: #212433 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<b>SDS reachability.</b> It is computationally intractable to tell if one brain state eventually evolves into another.
</div>
...
<div style="background-color: #212433 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<b>Computational free will.</b> We conjecture that finding a perturbation to cascade into a target state is computationally intractable, or equivalently, that the dynamics is hard to invert.
</div>
