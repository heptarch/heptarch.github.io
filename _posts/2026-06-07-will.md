...
<div style="background-color: #212433 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<b>Horizon-bounded control may be $\textsf{NP}$-complete.</b> We conjecture that finding a perturbation to cascade into a target state is computationally intractable, or equivalently, that the dynamics is hard to invert.
</div>
