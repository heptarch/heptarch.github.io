...
<div style="background-color: #212433 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<b>SDS reachability is $\textsf{PSPACE}$-complete.</b> It is computationally intractable to tell if one brain state eventually evolves into another.
</div>
...
<div style="background-color: #212433 ; padding: 20px; border: 0px solid
grey; line-height:1.5; border-radius: 15px">
<b>Horizon-bounded control may be $\textsf{NP}$-complete.</b> We conjecture that finding a perturbation to cascade into a target state is computationally intractable, or equivanently, that the dynamics is hard to invert.
</div>
