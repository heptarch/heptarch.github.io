...
*Exercise.* The interested reader should apply the dimensional analysis to AFL. You should find good agreement with the statistical average $N_\text{goals} \approx 26.5$ goals!
