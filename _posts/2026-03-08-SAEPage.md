...
See [GitHub](https://github.com/heptarch/SAEPage) for the code that
generated the plots.

### Acknowledgements

Thanks to Claude (Sonnet 4.6) for extensive help with coding,
experimental design, and theoretical quandaries.
