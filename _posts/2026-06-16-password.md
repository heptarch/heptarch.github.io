...
- `"correct horse battery staple"` comes out at $18$ bits of min surprisal, breakable in around $2$ milliseconds! It splits
- `"Tr0ub4dor&3"` is about $46$ bits, or $8$ days of guesswork, but it splits into two random pieces rather than recognizing a "munged" `troubador`; munging and other textual modifications would be a future improvement.
