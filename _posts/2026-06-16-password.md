...
So, I finally have the program I saw in my training video! It turns out that I propose is similar in many ways to Dropbox's [`zxcvbn``](https://github.com/dropbox/zxcvbn) password strength estimator.
