...
- `"correct horse battery staple"` comes out at $18$ bits of min surprisal, breakable in around $2$ milliseconds;
- `"Tr0ub4dor&3"` parses into two somewhat random pieces with $46$ bits, or about $8$ days of guesswork.
