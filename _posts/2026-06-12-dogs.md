...
Thus, we learn that behind the seemingly trivial game of spotting tiny dogs, there is a wealth of subtlety: from finite $n$ extreme values to Poisson point processes to Bayesian decision-making on the theory side, and on the practical side, a panoply of approximations needed for optimal play. 
