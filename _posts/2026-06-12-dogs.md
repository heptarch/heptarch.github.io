...
**June 12, 2026.** *The game of spotting maximally tiny dogs turns into a wide-ranging tutorial on the Bayesian mechanics of observing point processes.*
...
Thus, we learn that behind the seemingly trivial game of spotting tiny dogs, there is a wealth of subtlety: from finite-$n$ extreme values to Poisson point processes to Bayesian decision-making on the theory side, and on the practical side, a panoply of approximations needed for optimal play. The lesson is that  as you look harder at things, they tend to get deeper; don't look too hard unless you're prepared to blog about it!

## <a href="#toc">Appendix A. Updating as first spotter</a><a id="sec-8" name="sec-8"></a>

*This section was written by* `Claude` *because I had reached tiny dog-saturation point*.
