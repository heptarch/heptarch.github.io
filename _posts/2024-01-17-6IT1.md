...
This gives an easy proof of indistinguishability. Given any finite
  ...
  conclude that $T'$ contains the finite patch $T$. This
...
gravity called "holography" or the
...
$|gT\rangle$.
This equivalence is implemented directly by our code space.
...
Moreoever, inflation and deflation look a lot like [*renormalization*](https://en.wikipedia.org/wiki/Renormalization), also
