...
providing we know which part was erased. This sort of approach is
familiar from classical ECC; it's not clear if this can be viewed as a
tiling.<label for="sn-1"
       class="margin-toggle sidenote-number">
</label>
<input type="checkbox"
       id="sn-1"
       class="margin-toggle"/>
	   <span class="sidenote">
	   Homework for the author, and/or diligent readers!
	   </span>
