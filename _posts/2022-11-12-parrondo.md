...
mathjax: true
comments: true
title:  "Parrondo's paradox and the Second Law"
categories: [Math, Physics]
date:  2022-11-12
---

**November 12, 2022.** *I'll explain what Parrondo's paradox is, and why it
  isn't a paradox, in the language of quantum mechanics. I end with
...
solid purple;">
<b>Quantum Parrondo condition</b>
$$
...
I expect that the increase in correlation will
...
which explains why Bennett's demon does not violate the Second Law.
...
In fact, I suspect that rather than being about information per se,
entropy can be understood as a computational obfuscation of
microscopic information by chaotic dynamics.
I'll explore this speculation further another time!
