...
**July 11, 2026.** *Turns out you can't send quantum information without first cloning and encrypting it.*
...
Thus, Bob's density matrix is *maximally mixed* and he knows absolutely nothing about the state! This means teleportation transfers no information until Alice supplies her Bell bits $a,b$, and there is no contradiction in cloning the state; it is hidden inaccessibly behind a random $X^a Z^b$.
